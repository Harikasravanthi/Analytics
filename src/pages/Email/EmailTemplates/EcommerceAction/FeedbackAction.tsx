                                ...
                                <td className="container" width="600" style={{ fontFamily: "Roboto, sans-serif", boxSizing: "border-box", fontSize: "14px", display: "block !important", maxWidth: "600px !important", clear: "both", margin: "0 auto" }} valign="top">
                                    <div className="content" style={{ fontFamily: "Roboto, sans-serif", boxSizing: "border-box", fontSize: "14px", maxWidth: "600px", display: "block", margin: "0 auto", padding: "20px" }}>
                                                            ...
                                                            <tbody>
                                                                ...
                                                                <tr style={{ fontFamily: "Roboto, sans-serif", boxSizing: "border-box", fontSize: "14px", margin: 0 }}>
                                                                    <td className="content-block" style={{ fontFamily: "Roboto, sans-serif", boxSizing: "border-box", fontSize: "15px", verticalAlign: "top", margin: 0, padding: "0 0 0px" }} valign="top">
                                                                        ...
                                                                        <p style={{ fontFamily: "Roboto, sans-serif", marginBottom: "8px", color: "#878a99", lineHeight: 1.5 }}>Feel free to get in touch with us anytime via support from the link below. <Link to="https://themeforest.net/item/Swipe36-aspnet-core-admin-dashboard-template/36077495/support" target="_blank">https://themeforest.net/item/Swipe36-aspnet-core-admin-dashboard-template/36077495/support</Link></p>
                                        ...
                                        <div style={{ textAlign: "center", margin: "28px auto 0px auto" }}>
                                            <p style={{ fontFamily: "Roboto sans-serif", fontSize: "14px", color: "#98a6ad", margin: "0px" }}>2022 Swipe36. Design & Develop by Themesbrand</p>
                                        </div>
                                    </div>
                                </td>
                            </tr>
